...
Restricción: Utilizar el método add
"""
...
"""
Dados dos conjuntos calcular su interseccion utilizando el método intersection
"""
...
print(f" la interseccion es : {conjunto_interseccion}")
...
"""
Dados dos conjuntos calcular su union utilizando el caracter pipe
"""
...
print(f" la interseccion es : {conjunto_union}")
...
print(f" la diferencia es : {conjunto_diferencia}")
...
"""
Dados dos conjuntos calcular su diferencia utilizando el método difference
"""
...
print(f" la interseccion es : {conjunto_diferencia}")
...
print(f" la diferencia simetrica es : {conjunto_diferencia_simetrica}")
...
"""
Dados dos conjuntos calcular su diferencia diferencia simetrica utilizando el método symmetric_difference
"""
