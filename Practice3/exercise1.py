...
class Circle:
    def __init__(self, radio: float):
        self.radio = radio   # se define la variable de instancia

    def area(self) -> float:
        return round(pi * self.radio ** 2, 2)  # metodo de instancia
    
    def perimetro(self) -> float:
        return round(2 * pi * self.radio, 2)   # metodo de instancia
